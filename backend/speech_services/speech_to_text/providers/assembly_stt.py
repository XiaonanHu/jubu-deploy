import os
import sys  # Added for volume meter
import tempfile
import time
...
class AssemblyAITranscriber(STTProvider):
    """
    A class to handle microphone recording and transcription using AssemblyAI.
    """

    def __init__(self, api_key: str = "e3dfd9a1d0af47f4b2d66f3afc11e5f7"):
        """
        ...
        self.config = aai.TranscriptionConfig(speech_model=aai.SpeechModel.best)
    ...
    def record_audio_continuous(
        ...
        def audio_callback(indata, frames, time_info, status):
            nonlocal silence_counter, has_speech, recording_done, max_volume
    ...
    def transcribe_from_bytes(self, audio_bytes: bytes) -> str:
        """
        Transcribe audio data from bytes using AssemblyAI API.
